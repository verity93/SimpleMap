...
namespace DotSpatial.Data
{
    ...
    A world file stores an affine or first order transformation that maps from pixel space to map space. 
    When an image is georeferenced and the transformation can be expressed in the form of a world file, 
    Update Georeference creates a world file.
